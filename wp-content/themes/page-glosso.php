...
<body>
  ...
  <script src="http://localhost/testsite/wp-content/themes/authoring-tool/js/tooltip.js"></script><script src="http://localhost/testsite/wp-content/themes/authoring-tool/js/jquery.glossarize.js"></script>
  <script>
